...
"""
Circular linked list is of two types,
1. singly circular linked list
2. doubly circular linked list

Structure of singly circular linked list is same as normal linked list.
class Node:
    def __init__(self, data):
        self.data = data 
        self.next = None 

Example for this can includes, 
10 -> 20 -> 30 -> 10 (head position itself)
"""
...
"""
A Linked List is a popular data structure which is used to store elements. 
It is a linear data structure. It contains nodes that have a pointer to store the address 
of the next node and data which is the value of that node. Circular Linked List is a type of linked list 
that is circular in nature. In a circular linked list, every node has successor. In this data structure, 
every node points to the next node and the last node of the linked list points to the first node. 
This feature makes it circular in nature. It is essential to know that the circular linked lists have no end 
and we need to be careful while traversing the linked list. 
